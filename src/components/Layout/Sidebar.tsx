...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, onSectionChange }) => {
  ...
  return (
    <>
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-40 bg-white p-2 rounded-full shadow border"
      ...
      <div
        className={`
          fixed inset-y-0 left-0 z-30 bg-gray-50 w-64 border-r transform transition-transform duration-200
