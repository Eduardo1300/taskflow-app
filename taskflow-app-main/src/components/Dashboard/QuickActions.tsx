      ...
      <div className={`relative ${className}`}>
        ...
        {isExpanded && (
          <>
            ...
            />
            <div className="absolute top-full right-0 mt-3 w-96 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 z-[70] overflow-hidden animate-fade-in-up">
              {/* Header */}
